            ...
            <form role="form" action="{{route('post.store')}}" method="Post" enctype="multipart/form-data">
              @csrf
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <input type="text" name="subtitle" class="form-control" id="subtitle" placeholder="Enter Sub Post Title">
                  </div>
              	</div>
              	<div class="row">
                  <div class="form-group col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <textarea id="editor" class="form-control" name="body" id="body" placeholder="Post Description"></textarea>
                </div>
